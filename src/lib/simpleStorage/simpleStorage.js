...
(function(root, factory) {
    ...
    */
    ...
    var _storage_name = window.hi5_storage_name == undefined ? 'simpleStorage' : window.hi5_storage_name;
    ...
    function _loadStorage() {
        var source = localStorage.getItem(_storage_name);
